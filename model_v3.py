...
class StockLSTM(nn.Module):
    ...
    def __init__(self, input_size, hidden_size, num_layers, categorical_size, num_classes, dropout=0.5):
...
if __name__ == "__main__":
    ...
    model = StockLSTM(input_size, hidden_size, num_layers, categorical_size, num_classes, dropout=dropout_rate).to(device)
    ...
    # Load the best model
    best_model = load_model("best_stock_lstm_model.pth", device)
    ...
    save_model(best_model, "best_stock_lstm_model_final.pth")